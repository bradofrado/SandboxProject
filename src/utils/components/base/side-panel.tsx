                ...
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-700 border-r border-gray-200 dark:border-gray-700">
                    <ul className="space-y-2 font-medium">
                        {items.map((item, i) => {
                            ...
                            return <>
                                <li key={i}>
                                    <Link href={link} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group aria-selected:bg-gray-300 dark:aria-selected:bg-gray-500" aria-selected={selected}>

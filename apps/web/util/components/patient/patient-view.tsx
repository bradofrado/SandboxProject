...
const PatientInfo: React.FunctionComponent<{patient: Patient}> = ({patient}) => {
  ...
  return (
    <div className="flex flex-col gap-[5px] pt-0 pb-[116px]">
      <div className="flex px-4 w-full justify-between h-[140px] gap-0 pl-4 pr-0 pb-px">
...
const PatientBio: React.FunctionComponent<{ patient: Patient }> = ({
  ...
  return (
      <>
          <div className="flex flex-col justify-between w-[300px] gap-px mb-1.5">
						<Header>
          ...
          <div className="flex flex-col justify-between gap-1 -ml-2.5 mb-0 pt-0">

...
export const EditSquareIcon: IconComponent = (props) => {
  return <svg {...props} fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const TilesIcon: IconComponent = (props) => {
  return <svg {...props} fill="currentColor" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
...
export const UserIcon: IconComponent = (props) => {
  return <svg {...props} aria-hidden="true" fill="currentColor" viewBox="0 0 14 18" xmlns="http://www.w3.org/2000/svg">
      <path d="M7 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9Zm2 1H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z"/>
    </svg>
}

export const UsersIcon: IconComponent = (props) => {
  return <svg {...props} fill="currentColor" viewBox="0 0 20 18" xmlns="http://www.w3.org/2000/svg">
        <path d="M14 2a3.963 3.963 0 0 0-1.4.267 6.439 6.439 0 0 1-1.331 6.638A4 4 0 1 0 14 2Zm1 9h-1.264A6.957 6.957 0 0 1 15 15v2a2.97 2.97 0 0 1-.184 1H19a1 1 0 0 0 1-1v-1a5.006 5.006 0 0 0-5-5ZM6.5 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM8 10H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z"/>
    </svg>
}

export const UsersGroupIcon: IconComponent = (props) => {
  return <svg {...props} aria-hidden="true" fill="currentColor" viewBox="0 0 20 19" xmlns="http://www.w3.org/2000/svg">
...
export const UserCircleIcon: IconComponent = (props) => {
  return <svg {...props} aria-hidden="true" fill="none" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path d="M10 19a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0 0a8.949 8.949 0 0 0 4.951-1.488A3.987 3.987 0 0 0 11 14H9a3.987 3.987 0 0 0-3.951 3.512A8.948 8.948 0 0 0 10 19Zm3-11a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
  </svg>
}

export const BagIcon: IconComponent = (props) => {
  return <svg {...props} fill="currentColor" viewBox="0 0 18 20" xmlns="http://www.w3.org/2000/svg">
        <path d="M17 5.923A1 1 0 0 0 16 5h-3V4a4 4 0 1 0-8 0v1H2a1 1 0 0 0-1 .923L.086 17.846A2 2 0 0 0 2.08 20h13.84a2 2 0 0 0 1.994-2.153L17 5.923ZM7 9a1 1 0 0 1-2 0V7h2v2Zm0-5a2 2 0 1 1 4 0v1H7V4Zm6 5a1 1 0 1 1-2 0V7h2v2Z"/>
    </svg>
}

export const SigninIcon: IconComponent = (props) => {
  return <svg {...props} fill="none" viewBox="0 0 18 16" xmlns="http://www.w3.org/2000/svg">
        <path d="M1 8h11m0 0L8 4m4 4-4 4m4-11h3a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-3" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
    </svg>
}
...
export const HamburgerIcon: IconComponent = (props) => {
  return <svg {...props} aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        <path clipRule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z" fillRule="evenodd" />
    </svg>
}
...
export const TridotIcon: IconComponent = (props) => {
  return <svg {...props} aria-hidden="true" fill="currentColor" viewBox="0 0 16 3" xmlns="http://www.w3.org/2000/svg">
        <path d="M2 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Zm6.041 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM14 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Z"/>
    </svg>
}

export const RightArrowIcon: IconComponent = (props) => {
  return <svg {...props} viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      <path clipRule="evenodd" d="M20 10C20 4.48 15.52 0 10 0C4.48 0 0 4.48 0 10C0 15.52 4.48 20 10 20C15.52 20 20 15.52 20 10ZM6 9H10V6L14 10L10 14V11H6V9Z" fillRule="evenodd"  />
    </svg>
}
...
export const FolderIcon: IconComponent = (props) => {
	return (
		<svg {...props} className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const UploadIcon: IconComponent = (props) => {
	return (
		<svg {...props} fill="none" viewBox="0 0 20 16" xmlns="http://www.w3.org/2000/svg">
